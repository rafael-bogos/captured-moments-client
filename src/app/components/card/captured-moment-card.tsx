...
export const CapturedMomentCard = ({
  ...
  return (
    <article
      className="border rounded-lg overflow-hidden bg-white hover:shadow-lg hover:shadow-slate-200 transition-all ease-in-out relative"
    >
      <img
        src={imageUrl}
        alt={title}
      ...
      <button
        className="w-12 h-12 flex items-center justify-center cursor-pointer bg-white/40 rounded-lg border-white/30 absolute top-4 right-4"
